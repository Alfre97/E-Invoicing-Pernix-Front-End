...
export class ReceiverService {
  ...
  addUser(receiver: UserEmitterReceiver) {
    ...
    const userData = {
      ...
      locationProvinceName: receiver.locationProvinceName,
      locationCantonName: receiver.locationCantonName,
      locationDistrictName: receiver.locationDistrictName,
      locationNeighborhoodName: receiver.locationNeighborhoodName,
